    ...
    >
      ...
      >
        {collapsed ? (
          <Tooltip>
            <TooltipTrigger asChild>
              <Link to="/factory" aria-label="Factory" aria-current={location.pathname === "/factory" ? "page" : undefined} className="factory-nav-link factory-nav-link--collapsed">
                <IconApps className="size-4 shrink-0" strokeWidth={1.8} />
              </Link>
            </TooltipTrigger>
            <TooltipContent side="right">Factory</TooltipContent>
          </Tooltip>
        ) : (
          <Link to="/factory" aria-current={location.pathname === "/factory" ? "page" : undefined} className="factory-nav-link">
            <IconApps className="size-4 shrink-0" strokeWidth={1.8} />
            <span>Factory</span>
          </Link>
        )}
