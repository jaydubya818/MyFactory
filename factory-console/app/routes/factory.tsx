...
export default function FactoryRoute() {
  ...
  return <div className="factory-route" data-agent-ready={agentEngine.missing ? "false" : "true"}>
    {queueQuery.data?.supervisorUiOrigin && <nav className="factory-workspace-links" aria-label="Factory tools"><span>Local supervisor</span><a href={`${queueQuery.data.supervisorUiOrigin}/?new=1`} target="_blank" rel="noopener noreferrer">New WorkOrder <IconArrowRight size={14} /></a><a href={`${queueQuery.data.supervisorUiOrigin}/?view=builder`} target="_blank" rel="noopener noreferrer">App builder <IconArrowRight size={14} /></a></nav>}
