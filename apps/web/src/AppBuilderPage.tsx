...
export default function AppBuilderPage({ onCreate, pending, serverError }: Props) {
  ...
  return (
    <main className="main-panel builder-page" id="main-content">
      ...
      <div className="builder-intro"><span className="builder-intro__mark"><Icon name="sparkle" size={20} /></span><div><strong>What this prepares</strong><p>A WorkOrder, a selected template version, and local scaffold files. The app is not previewed or published by this step.</p></div></div>
